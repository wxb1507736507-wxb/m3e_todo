        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            _Row(
              ...
              text: AppStrings.courseDetailRoomPrefix + (course.room ?? '未填写'),
            ),
            _Row(
              icon: Icons.person_outline,
              text: AppStrings.courseDetailNotePrefix + (course.note ?? '未填写'),
            ),
            // One line per weekly meeting, with the clock times the term gives
            // those periods — which is what the reader came for.
            ...
            Row(
              children: <Widget>[
                ...
                FilledButton.tonalIcon(
                  onPressed: () {
                    // The sheet closes before the editor opens, rather than
                    // staying behind it: a detail sheet left open behind a form
                    // is a sheet showing what the course used to be, and after
                    // saving there would be two versions of the same course on
                    // screen with no way to tell which is which.
