...
abstract final class AppTheme {
  static ThemeData light(AppColorSeed seed) {
    return _build(AppColorSchemes.light(seed));
  }

  static ThemeData dark(AppColorSeed seed) {
    return _build(AppColorSchemes.dark(seed));
  }
  ...
  static ThemeData _build(ColorScheme colors) {
    ...
    return base.copyWith(
      ...
      appBarTheme: AppComponentThemes.appBar(colors, text),
      ...
      navigationRailTheme: AppComponentThemes.navigationRail(colors, text),
      navigationBarTheme: AppComponentThemes.navigationBar(colors, text),
